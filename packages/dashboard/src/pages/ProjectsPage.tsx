      ...
      <div className="flex relative" style={{ zIndex: 1 }}>
        ...
        <aside className="w-60 shrink-0 p-4 overflow-y-auto"
          ...
          <div className="space-y-1">
            {[
              { label: "Manage Team", desc: "Members & roles", icon: "M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8zm-7.978-1A.261.261 0 017.002 13c.001-.246.154-.986.832-1.664C8.484 10.68 9.484 10 11 10c1.516 0 2.516.68 3.166 1.336.678.678.83 1.418.832 1.664a.261.261 0 01-.018.02H7.022zM11 7a2 2 0 100-4 2 2 0 000 4zm3-2a3 3 0 11-6 0 3 3 0 016 0z", action: () => navigate(`/teams/${activeTeam?.id}/settings#members`) },
              { label: "Team Rules", desc: "Claude instructions", icon: "M3.75 2A1.75 1.75 0 002 3.75v8.5c0 .966.784 1.75 1.75 1.75h5.5c.966 0 1.75-.784 1.75-1.75v-8.5A1.75 1.75 0 009.25 2h-5.5zM3.5 3.75a.25.25 0 01.25-.25h5.5a.25.25 0 01.25.25v8.5a.25.25 0 01-.25.25h-5.5a.25.25 0 01-.25-.25v-8.5zM5 5.5a.5.5 0 01.5-.5h2a.5.5 0 010 1h-2a.5.5 0 01-.5-.5zm0 2a.5.5 0 01.5-.5h2a.5.5 0 010 1h-2a.5.5 0 01-.5-.5z", action: () => navigate(`/teams/${activeTeam?.id}/settings#rules`) },
