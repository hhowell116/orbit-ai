        ...
        <aside className="w-60 shrink-0 p-4 overflow-y-auto"
          ...
          <div className="space-y-1">
            {[
              ...
              { label: "Team Rules", desc: "Claude instructions", icon: "M3.75 2A1.75 1.75 0 002 3.75v8.5c0 .966.784 1.75 1.75 1.75h5.5c.966 0 1.75-.784 1.75-1.75v-8.5A1.75 1.75 0 009.25 2h-5.5zM3.5 3.75a.25.25 0 01.25-.25h5.5a.25.25 0 01.25.25v8.5a.25.25 0 01-.25.25h-5.5a.25.25 0 01-.25-.25v-8.5zM5 5.5a.5.5 0 01.5-.5h2a.5.5 0 010 1h-2a.5.5 0 01-.5-.5zm0 2a.5.5 0 01.5-.5h2a.5.5 0 010 1h-2a.5.5 0 01-.5-.5z", action: () => navigate(`/teams/${activeTeam?.id}/settings`) },
